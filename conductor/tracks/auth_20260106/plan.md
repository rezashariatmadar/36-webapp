...
- [x] Task: Initialize Django Project & Auth App
...
- [x] Task: Implement National ID Validation Logic
...
- [x] Task: Create Custom User Model
...
- [x] Task: Implement Phone Number Validation
